...
write.table(finaldata,file = "./data/IEV.txt",sep = ",",row.names = FALSE,col.names=FALSE)  # write the IEV data to file
write.table(finaldata,file = "./data/IEVS.txt",sep = ",",row.names = FALSE,col.names=FALSE)  # # write the IEV data to file
write.table(finaldata,file = "./data/IEV.csv",sep = ",",row.names = FALSE,col.names=TRUE)  # write the IEV data to csv file
